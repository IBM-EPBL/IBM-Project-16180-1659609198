...
#generate random values for random variables
...
#connect and send a datapoint binlevel and weight with value integer value into the cloud as a type of event for every 10 seconds
deviceCli.connect()
